...
- **Signal:** Workload Overview sessions completed. Deep understanding of platform established.
...
- **Signal:** Customer expressed interest in AI-powered security reporting during workload sessions
- **Engagement:** PoC / workshop — Bedrock-powered security finding aggregation and reporting
- **Expected Impact:** Innovation showcase, deepen AI/ML adoption
